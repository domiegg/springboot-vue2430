	...
	<body>
			<form action="updateShiyanchengji.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改实验成绩<input type="hidden" name="id" value="${shiyanchengji.id}" /></td>
						</tr>
		...
		<tr ><td width="200">学号：</td><td><input name='xuehao' type='text' id='xuehao' onblur='' style='border:solid 1px #000000; color:#666666' value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly"  readonly='readonly' /></td></tr>
		...
		<tr style='display:none'><td width="200">学生成绩：</td><td><input name='xueshengchengji' type='text' id='xueshengchengji' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
