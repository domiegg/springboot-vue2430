...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShiyanxiangmu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改实验项目<input type="hidden" name="id" value="${shiyanxiangmu.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.xiangmubianhao.value='${shiyanxiangmu.xiangmubianhao}';</script>	<script language="javascript">document.form1.shiyanmingcheng.value='${shiyanxiangmu.shiyanmingcheng}';</script>	<script language="javascript">document.form1.yanjiuketi.value='${shiyanxiangmu.yanjiuketi}';</script>	<script language="javascript">document.form1.yuqichengguo.value='${shiyanxiangmu.yuqichengguo}';</script>	<script language="javascript">document.form1.shiyanshijian.value='${shiyanxiangmu.shiyanshijian}';</script>	<script language="javascript">document.form1.xiangmujianjie.value='${shiyanxiangmu.xiangmujianjie}';</script>	<script language="javascript">document.form1.zhidaolaoshi.value='${shiyanxiangmu.zhidaolaoshi}';</script>	
					 </table>
			</form>
   </body>
</html>
