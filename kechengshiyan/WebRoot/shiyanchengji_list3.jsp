...
body,td,th {
    ...
    <td>${u.xueshengchengji}</td>
                              ...
                              <td align="center"><a href="doUpdateShiyanchengjilb.do?id=${u.id }">成绩</a>  <a href="deleteShiyanchengji.do?id=${u.id }"
		 ...
		 <%
			String sql="select * from shiyanchengji where zhidaolaoshi='"+(String)request.getSession().getAttribute("username")+"'  ";
