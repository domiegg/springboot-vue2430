...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shiyanchengjiList.do" name="myform" method="post">
		 ...
		 <%
			String sql="select * from shiyanchengji where 1=1 ";
...
while(RS_result.next()){
		...
		共计学生成绩:<%=xueshengchengjiz%>； 其中最高学生成绩：<%=zgfxueshengchengji%>；最低学生成绩：<%=zdfxueshengchengji%>；平均学生成绩：<%out.print(Math.round(1000*(xueshengchengjiz/i))/1000.0);%>；
		 ...
		 <c:if test="${page.page>1}">
              <a href="shiyanchengjiList.do?page=1" >首页</a>
             <a href="shiyanchengjiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shiyanchengjiList.do?page=${page.page+1 }">下一页</a>
			<a href="shiyanchengjiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
