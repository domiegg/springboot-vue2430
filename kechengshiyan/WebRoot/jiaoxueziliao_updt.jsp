...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateJiaoxueziliao.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改教学资料<input type="hidden" name="id" value="${jiaoxueziliao.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${jiaoxueziliao.bianhao}';</script>	<script language="javascript">document.form1.mingcheng.value='${jiaoxueziliao.mingcheng}';</script>	<script language="javascript">document.form1.leibie.value='${jiaoxueziliao.leibie}';</script>	<script language="javascript">document.form1.jianjie.value='${jiaoxueziliao.jianjie}';</script>	<script language="javascript">document.form1.fujian.value='${jiaoxueziliao.fujian}';</script>	<script language="javascript">document.form1.faburen.value='${jiaoxueziliao.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
