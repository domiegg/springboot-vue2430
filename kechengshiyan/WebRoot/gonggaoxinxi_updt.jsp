...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateGonggaoxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改公告信息<input type="hidden" name="id" value="${gonggaoxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.biaoti.value='${gonggaoxinxi.biaoti}';</script>	<script language="javascript">document.form1.neirong.value='${gonggaoxinxi.neirong}';</script>	<script language="javascript">document.form1.faburen.value='${gonggaoxinxi.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
